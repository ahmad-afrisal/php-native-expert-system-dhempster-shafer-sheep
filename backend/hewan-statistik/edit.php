            ...
            <div class="row">
              <div class="col-md-12">
                <?php
                  ...
                  $query = mysqli_query($koneksi, "SELECT * FROM tbl_jenis_hewan  WHERE kode_hewan='$kode_hewan'");
                        ...
                        <div class="col-12">
                          <div class="form-group">
                            ...
                            <input
                              ...
                              disabled
                            />
                            <input type="hidden" name="kode_hewan"  value="<?= $data['kode_hewan']; ?>">
                          </div>
                          <div class="form-group">
                            <label for="kode_kriteria">Nama Hewan</label>
                            <input
                              type="text"
