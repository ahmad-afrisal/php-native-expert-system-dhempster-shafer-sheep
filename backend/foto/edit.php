            ...
            <div class="row">
              <div class="col-md-12">
                <?php
                  ...
                  $query = mysqli_query($koneksi, "SELECT * FROM tbl_galeri_foto  WHERE id='$id'");
              ...
              <div class="row">
                ...
                <?php
                    ...
                    $query = mysqli_query($koneksi, "SELECT * FROM tbl_galeri_foto_detail  WHERE id_galeri_foto='$id'");
                    ...
                    <div class="col-4">
                      <div class="card">
                        <div class="card-header">
                          <div class="card-head-row card-tools-still-right">
                            <div class="card-tools">
                              <a href="delphoto.php?id_detail=<?= $data['id']; ?>"
                                class="btn btn-icon btn-link btn-danger btn-xs"
                              >
                        ...
                        <div class="card-body">
                          <div class="row">
                            <div class="col-12">
                              <img src="../../frontend/img/foto/<?= $data['foto']; ?>" alt="" srcset="" class="img-fluid">
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <form action="upphoto.php" method="post" enctype="multipart/form-data">
                <div class="d-grid gap-2">
                  ...
                  <button class="btn btn-primary" type="button"  onclick="thisFileUpload()">Upload Gambar</button>
