  ...
  <body>
    ...
    <div class="row gy-4">
        ...
        <div class="team-member">
            ...
            <img src="frontend/img/doctors/doctors-1.jpg" class="img-fluid" alt="">
            <div class="social">
        ...
        <div class="team-member">
            <div class="member-img">
            <img src="frontend/img/doctors/doctors-2.jpg" class="img-fluid" alt="">
            <div class="social">
                <a href=""><i class="bi bi-twitter-x"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
                <a href=""><i class="bi bi-instagram"></i></a>
        ...
        <div class="team-member">
            <div class="member-img">
            <img src="frontend/img/doctors/doctors-3.jpg" class="img-fluid" alt="">
            <div class="social">
                <a href=""><i class="bi bi-twitter-x"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
                <a href=""><i class="bi bi-instagram"></i></a>
        ...
        <div class="team-member">
            <div class="member-img">
            <img src="frontend/img/doctors/doctors-4.jpg" class="img-fluid" alt="">
            <div class="social">
                <a href=""><i class="bi bi-twitter-x"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
                <a href=""><i class="bi bi-instagram"></i></a>
